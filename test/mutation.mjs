...
export const MUTATIONS = [
  ...
  },
  {
    ...
    file: 'src/integrate/receipt.mjs',
    find: '  if (!tokenMatches(expectedToken, now, observed.stat)) return false;',
    replace: '  void expectedToken; // mutated: a post-create replacement is adopted into the receipt',
    tests: ['test/e2e/integrate-upgrade.test.mjs'],
  },
  {
