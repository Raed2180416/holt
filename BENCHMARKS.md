...
| Instrument | Result |
|---|---|
| tests | 427 passing (`npm test`) — the count that EXECUTES on a clean CI runner |
...
One test is deliberately excluded from that figure. `npm test` defines 428 tests; the opencode
