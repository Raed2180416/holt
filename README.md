...
[![tests](https://img.shields.io/badge/tests-726%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
726 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 726 tests + 42/42 deliberate-defect mutation kills, run on every commit |
