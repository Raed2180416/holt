...
[![tests](https://img.shields.io/badge/tests-780%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-46%2F46%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
|---|---|
| Core scan, safety, actions, CLI | 780 tests + 46/46 deliberate-defect mutation kills, run on every commit |
