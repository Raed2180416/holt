...
[![tests](https://img.shields.io/badge/tests-792%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-51%2F51%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
|---|---|
| Core scan, safety, actions, CLI | 792 tests + 51/51 deliberate-defect mutation kills, run on every commit |
