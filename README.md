...
[![tests](https://img.shields.io/badge/tests-783%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-47%2F47%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
783 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 783 tests + 47/47 deliberate-defect mutation kills, run on every commit |
