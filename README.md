...
[![tests](https://img.shields.io/badge/tests-762%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
762 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 762 tests + 43/43 deliberate-defect mutation kills, run on every commit |
