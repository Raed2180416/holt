...
[![tests](https://img.shields.io/badge/tests-698%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
698 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 698 tests + 42/42 deliberate-defect mutation kills, run on every commit |
