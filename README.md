...
[![tests](https://img.shields.io/badge/tests-752%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
752 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 752 tests + 43/43 deliberate-defect mutation kills, run on every commit |
