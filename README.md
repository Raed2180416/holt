...
[![tests](https://img.shields.io/badge/tests-777%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-45%2F45%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
777 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 777 tests + 45/45 deliberate-defect mutation kills, run on every commit |
