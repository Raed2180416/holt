...
[![tests](https://img.shields.io/badge/tests-755%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-43%2F43%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
|---|---|
| Core scan, safety, actions, CLI | 755 tests + 43/43 deliberate-defect mutation kills, run on every commit |
