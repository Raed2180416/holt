...
[![tests](https://img.shields.io/badge/tests-471%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
471 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 471 tests + 39/39 deliberate-defect mutation kills, run on every commit |
