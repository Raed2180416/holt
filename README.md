...
[![tests](https://img.shields.io/badge/tests-382%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
382 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 382 tests + 29/29 deliberate-defect mutation kills, run on every commit |
