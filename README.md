...
[![tests](https://img.shields.io/badge/tests-786%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-49%2F49%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
|---|---|
| Core scan, safety, actions, CLI | 786 tests + 49/49 deliberate-defect mutation kills, run on every commit |
