...
[![tests](https://img.shields.io/badge/tests-1064%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
1064 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 1064 tests + 79/79 deliberate-defect mutation kills, run on every commit |
