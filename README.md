...
[![tests](https://img.shields.io/badge/tests-466%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
[![mutation score](https://img.shields.io/badge/mutation%20score-39%2F39%20killed-brightgreen)](#the-test-suite-attacks-itself)
...
466 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 466 tests + 39/39 deliberate-defect mutation kills, run on every commit |
