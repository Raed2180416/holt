...
[![tests](https://img.shields.io/badge/tests-461%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
461 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 461 tests + 39/39 deliberate-defect mutation kills, run on every commit |
