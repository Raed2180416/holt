...
[![tests](https://img.shields.io/badge/tests-467%20passing-brightgreen)](https://github.com/raed2180416/holt/actions/workflows/ci.yml)
...
467 tests, and the interesting ones are the hostile ones:
...
|---|---|
| Core scan, safety, actions, CLI | 467 tests + 39/39 deliberate-defect mutation kills, run on every commit |
